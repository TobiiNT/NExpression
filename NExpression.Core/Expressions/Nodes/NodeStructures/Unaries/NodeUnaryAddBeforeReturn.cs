...
namespace NExpression.Core.Expressions.Nodes.NodeStructures.Unaries
{
    ...
    {
        public NodeUnaryAddBeforeReturn(NodeVariable VariableNode, IContext? Context) : base(Context, VariableNode, new NodeNonFloatingDecimal(1), MathOperation.AssignAddBeforeReturn)
        {
