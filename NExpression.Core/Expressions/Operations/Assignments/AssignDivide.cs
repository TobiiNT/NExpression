...
{
    internal class AssignDivide : IOperation
    {
        ...
        public Func<object?, object?, object?, object> Execute
        {
            get
            {
                ...
                {
                    return LogicExecute(MathOperation.AssignDivide, FirstArg, SecondArg);
                };
            }
        }
        ...
        public object LogicExecute(MathOperation Operation, object? Variable = null, object? SecondArg = null, object? ThirdArg = null)
        {
            ...
            {
                object? NewValue = new CalculationDivide().LogicExecute(Operation, ContextValue, SecondArg);
