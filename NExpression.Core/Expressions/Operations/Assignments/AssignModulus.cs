...
{
    internal class AssignModulus : IOperation
    {
        ...
        public Func<object?, object?, object?, object> Execute
        {
            get
            {
                ...
                {
                    return LogicExecute(MathOperation.AssignModulus, FirstArg, SecondArg);
                };
            }
        }
        ...
        public object LogicExecute(MathOperation Operation, object? Variable = null, object? SecondArg = null, object? ThirdArg = null)
        {
            ...
            {
                object? NewValue = new CalculationModulus().LogicExecute(Operation, CurrentValue, SecondArg);
