...
{
    internal class AssignBitwiseAND : IOperation
    {
        ...
        public Func<object?, object?, object?, object> Execute
        {
            get
            {
                ...
                {
                    return LogicExecute(MathOperation.AssignBitwiseAND, FirstArg, SecondArg);
                };
            }
        }
        ...
        public object LogicExecute(MathOperation Operation, object? Variable = null, object? SecondArg = null, object? ThirdArg = null)
        {
            ...
            {
                object? NewValue = new BitwiseAND().LogicExecute(Operation, ContextValue, SecondArg);
